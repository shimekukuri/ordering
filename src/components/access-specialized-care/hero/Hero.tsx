  ...
  return (
    <section className={`${styles.heroSection}`}>
      <div className={`${styles.overlay}`}>
        <h1 className="text-5xl md:text-5xl textShadow tracking-tight text-white relative z-10 pt-48 md:pt-64 lg:pt-96 pl-4 md:pl-8 lg:pl-12 lg:text-6xl font-bold md:w-3/4 lg:w-2/3">Simplify your medication systems</h1>
