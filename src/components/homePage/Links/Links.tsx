  ...
  return (
    <div className="h-[100dvh]">
      ...
      <div className="flex flex-1 md:hidden justify-around flex-wrap items-center p-4">
        <div className="min-w-[45%] max-w-[45%] md:min-w-0 bg-red-300 backdrop-blur-md opacity-0 animate-fade-in-200 p-2 rounded-full shadow-2xl mt-4">
          <img src={"./result.png"} />
        </div>
        <div className="min-w-[45%] max-w-[45%] md:min-w-0 bg-blue-300 backdrop-blur-md opacity-0 animate-fade-in-400 p-2 rounded-full shadow-2xl mt-4">
        ...
        <div className="min-w-[45%] max-w-[45%] md:min-w-0 bg-yellow-300 backdrop-blur-md opacity-0 animate-fade-in-600 p-2 rounded-full shadow-2xl mt-4">
          <img src="https://static.wixstatic.com/media/8f9d9b_82034209dc04459c9cd9c8b28f8da30e~mv2.png/v1/fill/w_410,h_410,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/8f9d9b_82034209dc04459c9cd9c8b28f8da30e~mv2.png" />
        </div>
        <div className="min-w-[45%] max-w-[45%] md:min-w-0 bg-green-300 backdrop-blur-md opacity-0 animate-fade-in-800 p-2 rounded-full shadow-2xl mt-4">
          <img src="https://static.wixstatic.com/media/8f9d9b_82034209dc04459c9cd9c8b28f8da30e~mv2.png/v1/fill/w_410,h_410,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/8f9d9b_82034209dc04459c9cd9c8b28f8da30e~mv2.png" />
        </div>
      </div>
      {/* Large Screens */}
